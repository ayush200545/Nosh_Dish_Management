      ...
      <div className="lg:w-1/2 flex items-center justify-center p-6 lg:p-12 relative z-10">
        ...
        <div className="w-full max-w-[420px] bg-white rounded-[2.5rem] p-8 sm:p-12 shadow-[0_20px_60px_-15px_rgba(0,0,0,0.05)] border border-gray-100 relative z-10">
          ...
          <button 
            ...
            disabled={isLoading || isGoogleLoading}
            className="mt-8 w-full flex items-center justify-center gap-3 py-4 px-4 border border-gray-200 rounded-2xl bg-white text-gray-700 font-bold hover:bg-gray-50 transition-colors shadow-sm disabled:opacity-50"
          >
            {isGoogleLoading ? (
              <span className="flex items-center gap-2 animate-pulse text-gray-500">
                <Bot size={20} className="animate-spin" /> Connecting to Google...
              </span>
            ) : (
              <>
